...
HEIGHT = 400 # Add 100 later for the state display 
...
screen = pg.display.set_mode((WIDTH, HEIGHT + DISPLAY_HEIGHT), 0, 32) # 400 x 500 display 
...
def draw_status(): 
    ...
    text_rect = text.get_rect(center=(WIDTH / 2, HEIGHT + DISPLAY_HEIGHT / 2)) 
